...
DEFAULT_VISUAL_BLOCKS = ROOT / "experiments" / "calgary_graph_rag" / "legacy_visual_blocks_adapter"
DEFAULT_OUTPUT_DIR = ROOT / "experiments" / "calgary_graph_rag" / "legacy_rule_extraction"
