#!/usr/bin/env python3
"""Offline graph/RAG packing experiment for Calgary local-selection outputs.

This experiment does not call an LLM. It starts from pruned candidate windows,
...
DEFAULT_LOCAL_DIR = ROOT / "outputs_prune" / "calgary" / "01_local_selection"
DEFAULT_OUTPUT_DIR = ROOT / "experiments" / "calgary_graph_rag"
...
def run_experiment(local_dir: Path, output_dir: Path) -> dict[str, Any]:
    ...
    result = {
        "case": "calgary_pipeline8_outputs_prune_local_selection",
