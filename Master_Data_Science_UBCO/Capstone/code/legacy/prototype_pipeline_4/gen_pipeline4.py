...
OUT = Path(__file__).with_name("pipeline4_integrated_rule_extraction.ipynb")
...
nb.cells = [
    md(
        """
        # Pipeline 4 - Integrated Rule Extraction (Improved Table Extraction)
    ...
    code(
        ...
        PIPELINE4_DIR = REPO_ROOT / "code" / "prototype_pipeline_4"
        PDF_DIR = PROTOTYPE_DIR / "pdfs"
        os.chdir(PIPELINE4_DIR)
        ...
        RUN_ID = f"pipeline4_{TARGET_CITY}_{TARGET_BUILDING_TYPE}_rule_pipeline"
        OUTPUT_DIR = PIPELINE4_DIR / "outputs" / TARGET_CITY / RUN_ID
        ...
        print("PIPELINE4_DIR:", PIPELINE4_DIR)
...
"""
    ...
    md(
        """
        ## 4. Structured Table Cell Facts  *(Pipeline 4 improvements)*
...
"""
    ...
    md(
        """
        ## 7. Deterministic Table Rule Extraction  *(Pipeline 4 improvement)*
...
"""
    ...
    code(
        ...
        expected_burnaby_keys = [
            ...
            # Pipeline 4 addition: large-lot coverage rule now extractable
        ...
        (RULE_DIR / "pipeline4_summary.md").write_text("\n".join(summary), encoding="utf-8")
        print((RULE_DIR / "pipeline4_summary.md").read_text(encoding="utf-8"))
