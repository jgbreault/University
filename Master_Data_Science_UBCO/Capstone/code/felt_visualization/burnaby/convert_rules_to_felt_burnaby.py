...
INPUT  = ROOT / "code/burnaby_rule_verification_prototype/outputs/m7_runs/burnaby_r1/google_gemini_3_1_flash_lite/gis_rule_contract.json"
OUTPUT = Path(__file__).parent / "burnaby_r1_rules.csv"
